  ...
  return (
    <footer id="sobre" className="bg-secondary text-secondary-foreground py-8 text-center">
      <div className="container mx-auto px-4">
        ...
        <p className="text-sm">&copy; {currentYear} Curitiba Recicla. Todos os direitos reservados. || Desenvolmento: <a href="https://github.com/edutronicos" target="_blank" rel="noopener noreferrer" className="inline-flex items-center">
